...
import com.mingri.langhuan.cabinet.page.PageTable;
...
public final class PageHlp {
	...
	public static <T> PageTable<T> toPageTable(List<T> page) {
		...
		if (page instanceof PageTable) {
			pgtb = (PageTable<T>) page;
		} else {
			pgtb = new PageTable<>();
			pgtb.setData(page);
		}
