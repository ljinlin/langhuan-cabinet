 ...
 * 2、该抽象类封装了基本常用的操作，静态函数用起来非常顺手：<br>
...
public class Result {
	...
	public static Result success() {
		Result res = new Result(ResultStatus.SUCCESS);
		return res;
	}
	...
	public static Result paramError() {
		Result res = new Result(ResultStatus.PARAM_ERROR);
		return res;
	}
	...
	public static Result sysError() {
		Result res = new Result(ResultStatus.SYS_ERROR);
		return res;
	}
